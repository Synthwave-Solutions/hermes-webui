...
window.__registerHermesLocale('ru', {
    ...
    offline_network_detail: 'SynthPulse сейчас недоступен из этого браузера.',
    offline_autorefresh: 'Я автоматически обновлю страницу, когда SynthPulse снова станет доступен.',
    ...
    cmd_skills: 'Показать доступные навыки SynthPulse',
    ...
    session_title_regenerate_desc: 'Попросить SynthPulse сгенерировать новое название на основе беседы',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_label_dashboard_mode: 'Официальная панель SynthPulse',
    ...
    settings_desc_gateway_status: 'Статус шлюза SynthPulse (Telegram, Discord, Slack и т.д.)',
    ...
    kanban_assignee_profiles_label: 'Профили SynthPulse',
    ...
    tab_dashboard: 'Панель SynthPulse',
    ...
    sign_out: 'Выйти',
    settings_label_shutdown: 'Остановить сервер SynthPulse Control',
    ...
    settings_shutdown_confirm_title: 'Остановить SynthPulse Control',
    settings_shutdown_confirm_message: 'Остановить сервер SynthPulse Control?',
    ...
    onboarding_lead: 'Краткая пошаговая настройка проверит SynthPulse, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть SynthPulse',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить SynthPulse Agent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера SynthPulse.',
    ...
    onboarding_notice_system_ready: 'SynthPulse Agent, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: 'SynthPulse Agent ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    ...
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера SynthPulse. Вы можете оставить её или заменить здесь.',
    ...
    onboarding_api_key_help_prefix: 'Сохраняется как секрет в вашем файле `.env` SynthPulse с помощью',
    ...
    onboarding_workspace_help: 'Выберите модель, которую SynthPulse должен использовать для новых чатов после завершения настройки.',
    ...
    settings_desc_voice_mode: 'Показывать кнопку голосового режима (аудиоволны) рядом с микрофоном диктовки. SynthPulse автоматически отправляет реплики после паузы и зачитывает ответы вслух. Требуется браузер с поддержкой распознавания речи и TTS.',

...
window.__registerHermesLocale('pt', {
    ...
    offline_network_detail: 'O SynthPulse está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o SynthPulse voltar a responder.',
    ...
    cmd_skills: 'Listar skills disponíveis do SynthPulse',
    ...
    status_hermes_home: 'Diretório SynthPulse',
    ...
    session_title_regenerate_desc: 'Peça ao SynthPulse para gerar um novo título a partir da conversa',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do SynthPulse Control.',
    ...
    settings_label_dashboard_mode: 'Painel oficial SynthPulse',
    ...
    settings_desc_gateway_status: 'Status do gateway SynthPulse (Telegram, Discord, Slack, etc.)',
    ...
    kanban_assignee_profiles_label: 'Perfis SynthPulse',
    ...
    tab_dashboard: 'Painel SynthPulse',
    ...
    settings_shutdown_confirm_title: 'Parar SynthPulse Control',
    settings_shutdown_confirm_message: 'Parar o servidor SynthPulse Control?',
    ...
    onboarding_title: 'Bem-vindo ao SynthPulse Control',
    onboarding_lead: 'Uma configuração rápida vai verificar SynthPulse, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar SynthPulse Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor SynthPulse.',
    ...
    onboarding_notice_system_ready: 'SynthPulse Agent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: 'SynthPulse Agent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    ...
    onboarding_workspace_help: 'Escolha modelo que SynthPulse deve usar para novos chats.',

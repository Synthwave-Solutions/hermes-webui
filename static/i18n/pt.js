...
window.__registerHermesLocale('pt', {
    offline_title: 'Conexão perdida',
    offline_browser_detail: 'O navegador informa que este dispositivo está offline.',
    offline_network_detail: 'O SynPulse está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o SynPulse voltar a responder.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" pode não funcionar com seu provedor configurado (${p}). Enviar assim mesmo, ou execute \`model picker\` no terminal para trocar.`,
    ...
    cmd_skills: 'Listar skills disponíveis do SynPulse',
    ...
    status_hermes_home: 'Diretório SynPulse',
    ...
    no_personalities: 'Nenhuma personalidade encontrada (adicione em the runtime personalities directory)',
    ...
    session_title_regenerate_desc: 'Peça ao SynPulse para gerar um novo título a partir da conversa',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do SynPulse Control.',
    ...
    settings_label_dashboard_mode: 'Painel oficial SynPulse',
    settings_desc_dashboard_mode: 'Mostra um link na barra de navegação quando o painel oficial synthpulse estiver acessível. URLs de proxy reverso público são armazenadas apenas como links no navegador e nunca são sondadas pelo servidor.',
    ...
    settings_desc_gateway_status: 'Status do gateway SynPulse (Telegram, Discord, Slack, etc.)',
    ...
    kanban_assignee_profiles_label: 'Perfis SynPulse',
    ...
    sign_out: 'Sair',
    settings_label_shutdown: 'Parar o servidor SynPulse Control',
    ...
    settings_shutdown_confirm_title: 'Parar SynPulse Control',
    settings_shutdown_confirm_message: 'Parar o servidor SynPulse Control?',
    ...
    providers_oauth_config_yaml_hint: 'Token configurado via config.yaml. Para atualizar, edite config.yaml ou rode agent auth.',
    providers_oauth_not_configured_hint: 'Não autenticado. Rode agent auth no terminal.',
    ...
    onboarding_title: 'Bem-vindo ao SynPulse Control',
    onboarding_lead: 'Uma configuração rápida vai verificar SynPulse, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar SynPulse Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor SynPulse.',
    ...
    onboarding_notice_system_ready: 'SynPulse Agent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: 'SynPulse Agent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    ...
    onboarding_notice_setup_already_ready: 'Setup de provedor SynPulse já detectado. Pode manter ou substituir.',
    ...
    onboarding_oauth_provider_not_ready_body: 'Esta instância usa <strong>{provider}</strong> com OAuth. Rode the agent auth command no terminal.',
    ...
    onboarding_api_key_help_prefix: 'Salvo como segredo no .env do SynPulse usando',
    ...
    onboarding_workspace_help: 'Escolha modelo que SynPulse deve usar para novos chats.',
    ...
    cron_script_path_hint: 'Resolvido em the runtime scripts directory salvo caminho absoluto. Edite o script no servidor para alterar o comportamento.',

...
window.__registerHermesLocale('es', {
    offline_title: 'Conexión perdida',
    offline_browser_detail: 'Tu navegador indica que este dispositivo está sin conexión.',
    offline_network_detail: 'SynPulse no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando SynPulse vuelva a estar disponible.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" puede no funcionar con tu proveedor configurado (${p}). Envía de todas formas, o ejecuta \`model picker\` en la terminal para cambiar.`,
    ...
    chat_mode_super: 'Súper agente',
    chat_mode_normal: 'Chat normal',
    chat_mode_super_title: 'Acceso completo a herramientas y skills',
    chat_mode_normal_title: 'Menos herramientas, respuestas más rápidas',
    chat_mode_switched: 'Modo de chat actualizado',
    chat_mode_failed: 'No se pudo cambiar el modo de chat: ',
    ...
    cmd_skills: 'Listar las skills de SynPulse disponibles',
    ...
    no_personalities: 'No se encontraron personalidades (añádelas a the runtime personalities directory)',
    ...
    session_title_regenerate_desc: 'Pide a SynPulse que genere un título nuevo a partir de la conversación',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_dashboard_mode: 'Panel oficial de SynPulse',
    settings_desc_dashboard_mode: 'Mostrar un enlace en la barra de navegación cuando el panel oficial de synthpulse esté accesible. Las URL de proxy inverso público se almacenan solo como enlaces en el navegador y nunca son sondeadas por el servidor.',
    ...
    settings_desc_gateway_status: 'Estado del gateway de SynPulse (Telegram, Discord, Slack, etc.)',
    ...
    kanban_assignee_profiles_label: 'Perfiles SynPulse',
    ...
    tab_dashboard: 'Panel de SynPulse',
    ...
    settings_desc_sync_insights: 'Refleja el uso de tokens de la WebUI en state.db para que /insights incluya datos de sesiones del navegador. Desactivado por defecto.',
    ...
    password_env_var_locked: 'La variable de entorno password environment variable está definida y tiene prioridad. Quítala y reinicia el servidor para gestionar la contraseña desde aquí.',
    password_env_var_locked_placeholder: 'Bloqueado: la variable password environment variable está definida',
    disable_auth: 'Desactivar autenticación',
    sign_out: 'Cerrar sesión',
    settings_label_shutdown: 'Detener el servidor SynPulse Control',
    ...
    settings_shutdown_confirm_title: 'Detener SynPulse Control',
    settings_shutdown_confirm_message: '¿Detener el servidor SynPulse Control?',
    ...
    onboarding_title: 'Bienvenido a SynPulse Control',
    onboarding_lead: 'Una guía rápida verificará SynPulse, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir SynPulse',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica SynPulse Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de SynPulse.',
    ...
    onboarding_notice_system_ready: 'Parece que SynPulse Agent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'SynPulse Agent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de SynPulse por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de SynPulse. Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de SynPulse. No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    onboarding_oauth_provider_not_ready_title: 'Proveedor OAuth no autenticado aún',
    onboarding_oauth_provider_not_ready_body: 'Esta instancia está configurada para usar <strong>{provider}</strong>, que utiliza OAuth en lugar de una clave API. Ejecuta the agent auth command o the model picker en una terminal para autenticarte y recarga la interfaz web.',
    ...
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de SynPulse usando',
    ...
    onboarding_workspace_help: 'Elige el modelo que SynPulse debe usar para nuevos chats cuando termine la configuración.',
    ...
    composer_control_chat_mode: 'Modo de chat',

...
window.__registerHermesLocale('es', {
    ...
    offline_network_detail: 'SynthPulse no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando SynthPulse vuelva a estar disponible.',
    ...
    cmd_skills: 'Listar las skills de SynthPulse disponibles',
    ...
    session_title_regenerate_desc: 'Pide a SynthPulse que genere un título nuevo a partir de la conversación',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_dashboard_mode: 'Panel oficial de SynthPulse',
    ...
    settings_desc_gateway_status: 'Estado del gateway de SynthPulse (Telegram, Discord, Slack, etc.)',
    ...
    kanban_assignee_profiles_label: 'Perfiles SynthPulse',
    ...
    tab_dashboard: 'Panel de SynthPulse',
    ...
    settings_label_shutdown: 'Detener el servidor SynthPulse Control',
    ...
    settings_shutdown_confirm_title: 'Detener SynthPulse Control',
    settings_shutdown_confirm_message: '¿Detener el servidor SynthPulse Control?',
    ...
    onboarding_title: 'Bienvenido a SynthPulse Control',
    onboarding_lead: 'Una guía rápida verificará SynthPulse, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir SynthPulse',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica SynthPulse Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de SynthPulse.',
    ...
    onboarding_notice_system_ready: 'Parece que SynthPulse Agent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'SynthPulse Agent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de SynthPulse por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de SynthPulse. Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de SynthPulse. No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    ...
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de SynthPulse usando',
    ...
    onboarding_workspace_help: 'Elige el modelo que SynthPulse debe usar para nuevos chats cuando termine la configuración.',

...
window.__registerHermesLocale('de', {
    offline_title: 'Verbindung verloren',
    offline_browser_detail: 'Dein Browser meldet, dass dieses Gerät offline ist.',
    offline_network_detail: 'SynPulse ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald SynPulse wieder erreichbar ist.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" funktioniert möglicherweise nicht mit Ihrem konfigurierten Provider (${p}). Trotzdem senden, oder \`model picker\` im Terminal ausführen.`,
    ...
    cmd_skills: 'Verfügbare SynPulse-Skills auflisten',
    ...
    session_title_regenerate_desc: 'SynPulse bitten, einen neuen Titel aus der Unterhaltung zu generieren',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_aux_advanced_timeout_desc: 'Request-Timeout für diese Hilfsaufgabe. Leer nutzt den SynPulse-Standard.',
    ...
    settings_label_dashboard_mode: 'Offizielles SynPulse-Dashboard',
    settings_desc_dashboard_mode: 'Zeigt einen Link in der Navigationsleiste an, wenn das offizielle SynPulse-Dashboard erreichbar ist. Öffentliche Reverse-Proxy-URLs werden nur als Browser-Links gespeichert und nie vom Server geprüft.',
    ...
    settings_desc_gateway_status: 'Status des SynPulse-Gateways (Telegram, Discord, Slack, usw.)',
    ...
    kanban_assignee_profiles_label: 'SynPulse-Profile',
    ...
    tab_dashboard: 'SynPulse-Dashboard',
    ...
    settings_desc_sync_insights: 'Spiegelt den WebUI-Token-Verbrauch in die state.db, sodass /insights Browser-Sitzungsdaten enthält. Standardmäßig aus.',
    ...
    sign_out: 'Abmelden',
    settings_label_shutdown: 'SynPulse Control-Server stoppen',
    ...
    settings_shutdown_confirm_title: 'SynPulse Control stoppen',
    settings_shutdown_confirm_message: 'SynPulse Control-Server stoppen?',
    ...
    onboarding_title: 'Willkommen bei SynPulse',
    ...
    onboarding_step_system_desc: 'SynPulse Agent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie SynPulse Agent.',
    ...
    cron_script_path_hint: 'Wird unter the runtime scripts directory aufgelöst, sofern kein absoluter Pfad. Verhalten über die Skriptdatei auf dem Server ändern.',

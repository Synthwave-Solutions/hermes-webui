...
window.__registerHermesLocale('de', {
    ...
    offline_network_detail: 'SynthPulse ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald SynthPulse wieder erreichbar ist.',
    ...
    cmd_skills: 'Verfügbare SynthPulse-Skills auflisten',
    ...
    session_title_regenerate_desc: 'SynthPulse bitten, einen neuen Titel aus der Unterhaltung zu generieren',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_aux_advanced_timeout_desc: 'Request-Timeout für diese Hilfsaufgabe. Leer nutzt den SynthPulse-Standard.',
    ...
    settings_label_dashboard_mode: 'Offizielles SynthPulse-Dashboard',
    settings_desc_dashboard_mode: 'Zeigt einen Link in der Navigationsleiste an, wenn das offizielle SynthPulse-Dashboard erreichbar ist. Öffentliche Reverse-Proxy-URLs werden nur als Browser-Links gespeichert und nie vom Server geprüft.',
    ...
    settings_desc_gateway_status: 'Status des SynthPulse-Gateways (Telegram, Discord, Slack, usw.)',
    ...
    kanban_assignee_profiles_label: 'SynthPulse-Profile',
    ...
    tab_dashboard: 'SynthPulse-Dashboard',
    ...
    settings_shutdown_confirm_title: 'SynthPulse Control stoppen',
    settings_shutdown_confirm_message: 'SynthPulse Control-Server stoppen?',
    ...
    onboarding_title: 'Willkommen bei SynthPulse',
    ...
    onboarding_step_system_desc: 'SynthPulse Agent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie SynthPulse Agent.',

...
window.__registerHermesLocale('en', {
  ...
  usage_load_failed:'Failed to load usage: ',
    ...
    profile_concept_desc_together: 'A profile can work in any workspace. Switching one never switches the other.',
    profile_concept_desc_workspaces: 'Where it works: the folder its commands and file edits run in.',
    profile_concept_example: 'The same profile can work in a client repository in the morning and in your own notes in the afternoon.',
    ...
    profile_concept_title: 'Profiles and workspaces',

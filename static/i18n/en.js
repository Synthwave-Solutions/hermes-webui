...
window.__registerHermesLocale('en', {
  skill_learning_created: 'Skill automatically created',
  skill_learning_patched: 'Skill automatically patched',
  ...
  skill_learning_memory_saved: 'Memory updated',
  skill_learning_user_saved: 'User profile updated',
  skill_learning_soul_saved: 'Bot personality updated',
  skill_learning_profile_memory_saved: 'Shared bot memory updated',
  skill_learning_profile_user_saved: 'Shared user profile updated',
  skill_learning_in_turn: 'This conversation · Visible only to you',
  ...
  governance_bootstrap_hint: 'This is a recovery administrator. Per-user access and approval controls do not restrict this account.',
  governance_access_level: 'Access level',
  governance_access_mode: 'Access management',
  governance_inherited_level: 'Keep existing roles',
  governance_legacy_policy: 'Keep existing policy',
  governance_level_user: 'User',
  governance_level_elevated: 'Elevated access',
  governance_level_admin: 'Admin',
  governance_mode_whitelist: 'Whitelist — deny until allowed',
  governance_mode_blacklist: 'Blacklist — allow except denied',
  governance_approval_flow: 'Approval flow',
  governance_approval_manual: 'Manual approval',
  governance_approval_automatic: 'Automatic AI approval and denial',
  governance_approval_prompt: 'What this user may and may not do',
  governance_approval_prompt_example: 'Allow reports in the assigned workspace. Deny sending customer data outside the company. Ask for manual review when the destination is unclear.',
  governance_whitelist_hint: 'Starts with no capabilities. Allow each needed capability below, within the assigned role and resource access.',
  governance_blacklist_hint: 'Allows capabilities within the assigned role and resource access, except items denied below.',
  governance_legacy_hint: 'Preserves the existing role, group and user grant behavior until you choose a mode.',
  governance_automatic_hint: 'AI approves or denies eligible actions using this policy. Permission limits still apply. Uncertain or unavailable decisions wait for manual review.',
  governance_manual_hint: 'Actions requiring approval wait for an authorized reviewer.',
  governance_prompt_required: 'Describe what this user may and may not do before enabling automatic approval.',
  governance_additional_grants: 'Application, tools and data to allow',
  governance_additional_denials: 'Application, tools and data to deny',
  governance_user_grants_note: 'Whitelist users receive only explicitly allowed capabilities within their assigned access. Blacklist users receive assigned access except the denied items below.',
  governance_deny_note: 'Denied items override allowed capabilities, including wildcard (*) grants. Automatic approval cannot override a denial.',
  governance_deny_wildcard_active: 'Wildcard access is limited by the denied items shown here.',
  governance_eff_note: 'Saved policy preview. Denied items remain blocked even when a wildcard is shown. Save changes to refresh this preview.',
  governance_access_permissions: 'Permissions',
  governance_access_profiles: 'Profiles and bots',
  governance_access_workspaces: 'Workspaces',
  governance_access_routes: 'Application routes',
  governance_access_tools: 'Agent tools',
  governance_access_toolsets: 'Tool groups',
  governance_access_models: 'Models',
  governance_access_providers: 'Model providers',
  governance_access_settingsread: 'Settings to view',
  governance_access_settingswrite: 'Settings to change',
  governance_access_filesread: 'Folders to read',
  governance_access_fileswrite: 'Folders to write',
  governance_access_workdirs: 'Command working folders',
  governance_access_environment: 'Environment variable names',
  governance_deny_skills_view_load: 'Skills view and load off',
  governance_deny_skills_manage: 'Skills management off',
  governance_explicit_denials: 'Explicit denials',
  "bot_documents_loading": "Loading bot documents\u2026",
  "bot_documents_title": "Knowledge files",
  "bot_documents_upload": "Upload documents from your computer",
  "bot_documents_find": "Find a document",
  "bot_documents_available": "Available bot documents",
  "bot_documents_save": "Save knowledge",
  "bot_documents_saving": "Saving knowledge selection\u2026",
  "bot_documents_saved": "Knowledge selection saved.",
  "bot_documents_retry": "Retry",
  "bot_documents_changed": "Selection changed. Choose Save knowledge to apply it.",

  "bot_editor_edit": "Edit bot",
  "bot_editor_tabs": "Bot configuration",
  "bot_editor_identity": "Identity & photo",
  "bot_editor_instructions": "Instructions",
  "bot_editor_memory_tab": "Memory & knowledge",
  "bot_editor_skills": "Skills",
  "bot_editor_connections": "Connections & tools",
  "bot_editor_access": "Access",
  "bot_editor_memory": "Bot memory",
  "bot_editor_memory_hint": "Shared with the users of this bot. Separate from My Notes and your personal user profile.",
  "bot_editor_knowledge_hint": "File selections are saved separately using Save knowledge below.",
  "bot_editor_knowledge_unavailable": "Knowledge files are unavailable. Reload the page.",
  "bot_editor_unavailable_selection": "Previously selected; currently unavailable. Remove this selection to save.",
  ...
  "chat_mentions_error": "Could not prepare recipients. Your draft is kept.",
    ...
    my_approvals_history: 'View request history',
    bot_description_empty: 'Give this bot a clear role so your team knows when to use it.',
    bot_color: 'Avatar color',
    bot_knowledge_files: 'Knowledge files',
    bot_knowledge_files_hint: 'One workspace file per line. Upload documents to the bot\'s chat workspace first. Files are read only when relevant and allowed for the person asking.',
    bot_read_only: 'You can use this bot. Ask an administrator to change its configuration.',
    bot_configuration_details: 'Configuration details',
    ...
    offline_autorefresh: 'I will refresh this page automatically when SynthPulse is reachable again.',
    ...
    mic_insecure_origin: 'Voice input needs a secure connection. Open SynthPulse over HTTPS or from localhost to use the microphone.',
    ...
    mcp_restart_hint: 'Server changes are read-only here for now. Edit config.yaml and restart the agent runtime for changes to take effect.',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" may not work with your configured provider (${p}). Send anyway, or run \`model picker\` in your terminal to switch.`,
    ...
    cmd_skills: 'List available runtime skills',
    ...
    settings_desc_max_tokens: 'Caps assistant output for new streaming turns. Leave blank to use the active bot config fallback.',
  ...
  status_agent_running:'Agent running',
    status_profile: 'Bot',
    status_hermes_home: 'Runtime home',
  ...
  usage_load_failed:'Failed to load usage: ',
    ...
    chat_mode_super_title: 'Full tool and skill access',
    chat_mode_normal_title: 'Fewer tools, faster replies',
    chat_mode_switched: 'Chat mode set',
    chat_mode_failed: 'Failed to change chat mode: ',
    // Group conversations: who else is in this chat
    group_people: 'Who is in this conversation',
    group_people_title: 'Who is in this conversation',
    group_people_desc: 'Everyone you pick can open this conversation and write in it. Each person\'s messages run under their own access, never yours.',
    group_people_search: 'Search colleagues',
    group_people_none: 'No colleagues found.',
    group_people_count: 'You + {n}',
    group_just_me: 'Just me',
    profile_photo_label: 'Profile photo',
    profile_photo_hint: 'Shown next to your messages in group conversations and in the people picker. Square crop, stored on this workstation only.',
    profile_photo_upload: 'Upload photo',
    profile_photo_remove: 'Remove',
    profile_photo_saving: 'Saving photo…',
    ...
    group_people_load_failed: 'Could not load the list of colleagues',
    ...
    btw_done: 'Side question answered',
    btw_failed: 'Side question failed: ',
    btw_label: 'Side question',
    btw_no_answer: 'No answer came back.',
    copy_file_path: 'Copy full path',
    ...
    cron_schedule_month_day_label: 'Day of the month',
    cron_schedule_time_hint: 'Local time on this workstation',
    cron_schedule_time_label: 'Time',
    cron_schedule_weekday_label: 'Day of the week',
    ...
    folder_add_as_space_msg: 'Add this folder as a space so it shows up in the workspace picker?',
    folder_add_as_space_title: 'Add as a space',
    fork_from_here: 'Start a new chat from here',
    forked_from: 'Continued from',
    kanban_archive_board: 'Archive board',
    kanban_archive_board_confirm: 'Archive this board? Its cards stay, but the board leaves the list.',
    kanban_back_to_board: 'Back to the board',
    kanban_block: 'Mark as blocked',
    kanban_board_archived: 'Board archived',
    kanban_board_name_required: 'A board needs a name',
    kanban_board_slug_required: 'A board needs a slug',
    kanban_bulk_action: 'Apply to selected',
    kanban_card_archive: 'Archive card',
    kanban_card_complete: 'Mark as done',
    kanban_new_board: 'New board',
    kanban_rename_board: 'Rename board',
    kanban_stats: 'Board statistics',
    kanban_unassigned: 'Unassigned',
    kanban_unblock: 'Remove the block',
    ...
    profile_concept_example: 'The same bot can work in a client repository in the morning and in your own notes in the afternoon.',
    profile_concept_label_example: 'For example',
    profile_concept_label_together: 'Together',
    profile_concept_subtitle: 'What the difference is',
    profile_concept_title: 'Bots and workspaces',
    reveal_failed: 'Could not open the file manager',
    reveal_in_finder: 'Show in file manager',
    share_session: 'Share this conversation',
    share_session_copy_existing: 'Copy the existing link',
    share_session_created: 'Share link created',
    share_session_existing_confirm: 'This conversation is already shared. Create a new link and invalidate the old one?',
    share_session_failed: 'Could not share this conversation',
    share_session_link_copied: 'Share link copied',
    share_session_refresh_snapshot: 'Update what the link shows',
    share_session_revoke_failed: 'Could not stop sharing',
    share_session_revoked: 'Sharing stopped',
    share_session_status_active: 'Shared: anyone with the link can read this',
    share_session_tooltip: 'Create a read-only link to this conversation',
    status_heading: 'Status',
    status_no: 'No',
    stop_sharing_session: 'Stop sharing',
    stop_sharing_session_confirm: 'Stop sharing? The existing link stops working immediately.',
    stop_sharing_session_tooltip: 'Revoke the link so it no longer opens',
    stream_stopped: 'Stopped',
    undo_exchange: 'Undo this exchange',
    update_hard_refresh_now: 'Reload now',
    group_people_owner_only: 'Only the person who started this conversation can change who is in it.',
    // Your own access requests: badge and decision notices
    access_pending_one: 'One request is waiting for a decision',
    access_pending_many: '{n} requests are waiting for a decision',
    access_notice_approved: 'Access granted: {what}',
    access_notice_rejected: 'Access declined: {what}',
    // The advisory block on the admin approvals queue
    advice_title: 'What this is and what we advise',
    advice_why: 'Why they asked',
    advice_risk: 'Worst case',
    advice_recommendation: 'Advice',
    advice_their_words: 'In their own words',
    advice_rec_grant: 'Grant it',
    advice_rec_grant_narrower: 'Grant something narrower',
    advice_rec_decline: 'Do not grant',
    advice_rec_needs_more_information: 'Ask them first',
    advice_from_model: 'Written by the assistant',
    advice_from_rules: 'From the risk catalogue',
    // Session toolsets (#493)
    session_toolsets:'Session Toolsets',
    session_toolsets_desc:'Use active bot defaults or choose a custom toolset list for this session',
    session_toolsets_global:'Active bot defaults',
    session_toolsets_profile_defaults:'Active bot defaults',
    session_toolsets_custom:'Custom override',
    session_toolsets_use_profile_defaults:'Use active bot defaults',
    ...
    session_toolsets_cleared:'Using active bot defaults',
    session_toolsets_failed:'Failed to update toolsets: ',
  untitled:'Untitled',
    no_personalities: 'No personalities found (add them to the runtime personalities directory)',
    ...
    session_title_regenerate_desc: 'Ask SynthPulse to generate a fresh title from the conversation',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for SynthPulse Control.',
    ...
    settings_label_show_titlebar_profile: 'Show bot switcher in titlebar',
    settings_desc_show_titlebar_profile: 'When enabled, a bot switcher button appears in the top-left app titlebar so you can change bots from any tab. Off by default; the composer footer always has a bot switcher regardless of this setting.',
    ...
    composer_control_chat_mode: 'Chat mode',
    ...
    settings_plugins_meta: 'View installed runtime plugins and the lifecycle hooks they register. This panel is read-only.',
    settings_plugins_empty: 'No runtime plugins are currently visible. Install or enable plugins from the CLI/config to see them here.',
    ...
    settings_tab_access: 'Access requests',
    settings_label_capacity: 'Upstream capacity alerts',
    settings_desc_capacity: 'Warn before an upstream account runs empty. Users see a plain-language message; the diagnostics stay here.',
    capacity_poll: 'Check every (seconds)',
    capacity_cooldown: 'One alert per (seconds)',
    capacity_thresholds: 'Warn at remaining %, per provider',
    capacity_destination: 'Also send alerts to',
    capacity_save: 'Save capacity settings',
    capacity_saved: 'Saved',
    capacity_refreshed: 'Capacity alerts refreshed',
    capacity_no_alerts: 'No capacity alerts. Providers have been serving normally.',
    capacity_ack: 'Mark handled',
    capacity_dispatch_failed: 'External alert not delivered',
    saving: 'Saving…',
    ...
    approval_resume_unavailable: 'Continuation status is temporarily unavailable. Your access requests are shown below.',
    ...
    access_requested_on: 'Requested',
    access_decided_by: 'Decided by',
    access_next_pending: 'Waiting for an admin decision.',
    access_next_approved: 'Granted: try the action again.',
    access_next_rejected: 'Not granted. Ask an admin if you need this for your work.',
    insights_scope_mine: 'My insights: only your own conversations are counted.',
    insights_scope_global: 'Global insights: every conversation on this instance (administrator view).',
    ...
    settings_help_docs_desc: 'Guides, configuration reference, and operational documentation.',
    ...
    settings_aux_task_profile_describer: 'Bot describer',
    settings_aux_task_profile_describer_desc: 'bot summaries',
    ...
    settings_aux_advanced_timeout_desc: 'Request timeout for this auxiliary task. Blank uses the runtime default.',
    ...
    settings_label_dashboard_mode: 'Legacy dashboard',
    settings_desc_dashboard_mode: 'Show a nav-rail link when the official legacy dashboard is reachable. Public reverse-proxy URLs are stored as browser-only links and are never server-probed.',
    ...
    settings_desc_gateway_status: 'Status of the agent gateway (Telegram, Google Chat, API, etc.)',
    ...
    bot_tools: 'Tools, MCP and settings',
    tab_kanban: 'Kanban',
    kanban_board: 'Board',
    ...
    kanban_work_queue_hint: 'This is the SynthPulse work queue. Create or triage a task, assign it, move it to Ready, then let the dispatcher claim it.',
    ...
    kanban_view_lanes: 'Lanes by bot',
    kanban_view_consolidated: 'Consolidated view',
    kanban_view_lanes_saved: 'Kanban view: lanes by bot',
    ...
    kanban_assignee_profiles_label: 'Agent bots',
    kanban_assignee_other_label: 'Other (CLI lanes / removed bots)',
    kanban_assignee_unassigned: '— Unassigned (won\u2019t auto-run) —',
    kanban_ready_needs_assignee: 'You picked Unassigned + Ready. The dispatcher will skip this task. Submit again to confirm, or pick a bot.',
    ...
    kanban_dispatch_skipped_nonspawnable: 'skipped (unknown bot)',
    ...
    kanban_dependency_self: 'A task cannot depend on itself',
      ...
      kanban_lanes_by_profile: 'Lanes by bot',
      kanban_new_board: 'New board…',
    ...
    tab_dashboard: 'Legacy Dashboard',
    ...
    governance_title: 'Access governance',
    governance_subtitle: 'Manage who can use which parts of this workstation.',
    governance_desc: 'Roles, groups, and access policy for this workstation.',
    governance_overview: 'Overview',
    governance_users: 'Users',
    governance_groups: 'Groups',
    governance_approvals: 'Approvals',
    governance_preview: 'Preview access',
    governance_preview_title: 'Preview effective access',
    governance_preview_run: 'Preview',
    ...
    projects_empty_sub: 'Pick a project from the sidebar to see its conversations, spaces, scheduled work and status.',
    projects_unavailable: 'This view is not available for your account. Ask your administrator if you need it.',
    projects_none_yet: 'You do not have any projects on this workstation yet.',
    projects_truncated: 'Only the first entries are shown.',
    projects_system_label: 'System',
    projects_section_conversations: 'Conversations',
    projects_section_workspaces: 'Spaces',
    projects_section_files: 'Files',
    projects_section_jobs: 'Scheduled work',
    projects_section_status: 'Status',
    projects_section_delivery: 'Task board',
    projects_open_board: 'Open the shared task board',
    projects_shared_board_note: 'Shared',
    projects_source_project_record: 'Project',
    projects_source_conversations: 'Conversations',
    projects_source_workspaces: 'Spaces',
    projects_source_workspace_files: 'Files',
    projects_source_scheduled_jobs: 'Scheduled work',
    projects_source_project_os: 'Status document',
    projects_source_kanban_board: 'Task board',
    projects_integrations_title: 'Sources not connected yet',
    projects_connect_hint: 'Ask your administrator to connect a source before expecting it here.',
    projects_not_connected: 'Not connected',
    projects_state_not_configured: 'Not connected',
    projects_state_configured_not_readable: 'Set up, not readable here',
    projects_state_reader_missing: 'Connected, not read here yet',
    projects_meetings: 'Meetings',
    projects_notes: 'Notes',
    projects_code_reviews: 'Code reviews',
    projects_client_materials: 'Client materials',
    tab_integrations: 'Connections',
    integrations_title: 'Integrations',
    integrations_subtitle: 'Connect your accounts to third-party services.',
    integrations_desc: 'Connect third-party services to your account.',
    integrations_refresh: 'Refresh',
    integrations_my_connections: 'My connections',
    channels_title: 'Messaging channels',
    mychannels_title: 'Your bot',
    mychannels_intro: 'Your own bots run in your own profile: your memory, your skills, your governance. Telegram, Discord and Slack connect outbound, so each person can run one. Paste the token, link your id, then apply.',
    mychannels_shared: 'Your account uses the workstation\'s main bot. Link your platform ids below so messages there run under your governance.',
    mychannels_profile: 'Profile',
    mychannels_token: 'Bot token from @BotFather',
    mychannels_token_stored: 'Token stored',
    mychannels_token_missing: 'No bot yet',
    mychannels_save_token: 'Save token',
    mychannels_remove_bot: 'Remove bot',
    mychannels_your_id: 'Your Telegram user id',
    mychannels_your_id_hint: 'Send /start to @userinfobot on Telegram; it replies with your numeric id.',
    mychannels_link: 'Link',
    mychannels_links: 'Your linked platform ids',
    mychannels_no_links: 'Nothing linked yet.',
    mychannels_unlink: 'Unlink',
    mychannels_apply: 'Apply (restart bots)',
    mychannels_apply_hint: 'Restarts the people gateway so a new token or id takes effect. Takes about two minutes; other people\'s bots reconnect too.',
    mychannels_last_apply: 'Last applied {when} by {who}',
    mychannels_saved: 'Saved.',
    mychannels_linked: 'Linked.',
    mychannels_unlinked: 'Unlinked.',
    mychannels_applied: 'Bots are restarting.',
    mychannels_my_id: 'My {platform} id',
    mychannels_shared_platforms: 'Organisation bots (Teams, WhatsApp, Google Chat)',
    mychannels_shared_hint: 'One bot for the organisation; a linked id still runs in your own profile and governance.',
    mychannels_steps: '1. In Telegram open @BotFather, send /newbot, choose a name and a username ending in bot. 2. Copy the token (123456:ABC...). 3. Paste it here and save. 4. Link your Telegram id. 5. Apply, then message your bot.',
    channels_intro: 'Connect the bot to the chat tools your organisation uses. Each person on a platform is mapped to a person on this workstation, so the same governance applies there.',
    channels_restart_gateway: 'Restart gateway',
    channels_people_title: 'People on channels',
    channels_configure: 'Connect',
    channels_edit: 'Edit',
    channels_disable: 'Disconnect',
    channels_configured: 'Connected',
    channels_not_configured: 'Not connected',
    channels_allow_all: 'Everyone on this platform may message the bot',
    channels_allow_all_short: 'open to all',
    channels_pairing_short: 'pairing',
    channels_people_count: '{n} people mapped',
    channels_pending_title: 'Waiting for approval',
    channels_pending_row: '{name} on {platform} asked for access {age} min ago',
    channels_approve: 'Approve as',
    channels_approve_btn: 'Approve',
    channels_deny: 'Ignore',
    channels_add_person: '+ Map a person',
    channels_platform: 'Platform',
    channels_user_id: 'Platform user id',
    channels_person: 'Person',
    channels_remove: 'Remove',
    channels_no_people: 'Nobody is mapped yet. Approve a pairing request or map a person by id.',
    channels_saved: 'Channel saved. Restart the gateway to apply.',
    channels_disabled: 'Channel disconnected. Restart the gateway to apply.',
    channels_person_saved: 'Person mapped.',
    channels_person_removed: 'Mapping removed.',
    channels_approved: 'Access approved.',
    channels_revoked: 'Access revoked.',
    channels_restarting: 'Restarting the gateway. This takes about two minutes.',
    channels_failed: 'Channel action failed.',
    channels_secret_stored: 'Stored. Leave blank to keep.',
    channels_pick_person: 'Pick a person',
    channels_engine_missing: 'Pairing store not available on this server.',
    channels_profile: 'Runs as profile',
    channels_hook_unpublished: 'Webhook not public yet.',
    channels_publish: 'Publish via Funnel',
    channels_published: 'Webhook published.',
    channels_hook_unavailable: 'Public webhook URL is set by the deploy bootstrap on this host.',
    channels_hook_on_save: 'On save the webhook is published through Tailscale Funnel and the public URL appears on the card. Enter that URL at the provider.',
    channels_dialog_hint: 'Values go to the profile .env and are never shown again. Unknown users get a pairing code when they message the bot; approve them below.',
    integrations_all_connections: 'All connections',
    integrations_no_connections: 'No connections yet. Connect a service from the catalog below.',
    integrations_catalog: 'Available services',
    integrations_search_placeholder: 'Search providers...',
    integrations_all_categories: 'All',
    integrations_no_results: 'No providers match your search.',
    integrations_nango_down: 'Nango is unreachable; showing the catalog without connect state.',
    integrations_col_provider: 'Provider',
    integrations_col_connection: 'Connection',
    integrations_col_owner: 'Owner',
    integrations_col_created: 'Created',
    integrations_col_status: 'Status',
    integrations_owner_you: 'you',
    ...
    session_progress_queued: 'Queued',
    session_progress_running: 'Working',
    session_progress_waiting: 'Waiting for input',
    session_progress_completed: 'Completed',
    session_progress_failed: 'Failed',
    session_progress_canceled: 'Canceled',
    session_progress_unavailable: 'Status unavailable',
    integrations_connect_failed: 'Connect session could not be created.',
    integrations_setup_needed: 'Setup needed',
    integrations_setup_pending: 'Not ready yet: an admin has to finish the setup.',
    integrations_register_client: 'Register with provider',
    integrations_add_app_credentials: 'Add app credentials',
    integrations_save_credentials: 'Save and enable',
    integrations_callback_hint: 'Redirect URL to register at the provider:',
    integrations_scopes_label: 'Scopes (comma separated, optional)',
    integrations_repaired: 'Set up. It can be connected now.',
    integrations_repair_incomplete: 'Saved, but the setup is still incomplete.',
    ...
    integrations_docs: 'Docs',
    integrations_auth_api_key: 'API key',
    integrations_disconnect: 'Disconnect',
    integrations_disconnect_title: 'Disconnect service',
    integrations_disconnect_message: 'Remove this connection? Anything using it stops working until you reconnect.',
    integrations_disconnected: 'Connection removed.',
    integrations_request_access: 'Request access',
    integrations_waiting_approval: 'Waiting for approval',
    integrations_awaiting_approval: 'Waiting for admin approval',
    integrations_access_requested: 'Access requested. An admin has to approve it.',
    integrations_my_requests: 'My requests',
    governance_mode: 'Mode',
    governance_refresh: 'Refresh',
    governance_save: 'Save',
    governance_cancel: 'Cancel',
    governance_edit: 'Edit',
    governance_delete: 'Delete',
    governance_saved: 'Saved',
    governance_deleted: 'Deleted',
    governance_user_add: 'Add user',
    governance_user_edit: 'Edit user',
    governance_group_add: 'Add group',
    governance_group_edit: 'Edit group',
    governance_col_email: 'Email',
    governance_col_name: 'Name',
    governance_col_roles: 'Roles',
    governance_col_groups: 'Groups',
    governance_col_sso_groups: 'SSO groups',
    governance_col_time: 'Time',
    governance_col_event: 'Event',
    governance_col_reason: 'Reason',
    governance_col_method: 'Method',
    governance_col_path: 'Path',
    governance_col_subject: 'Subject',
    governance_roles_csv: 'Roles',
    governance_groups_csv: 'Groups',
    governance_sso_csv: 'SSO groups',
    governance_sso_group: 'SSO group',
    picker_placeholder: 'Pick from the list',
    picker_search: 'Search',
    picker_no_matches: 'No matches',
    picker_add_custom: 'Add',
    picker_clear: 'Clear selection',
    picker_remove: 'Remove',
    picker_pick_person: 'Pick a person',
    picker_pick_owner: 'Pick an owner (empty = shared)',
    picker_pick_members: 'Pick members',
    picker_pick_roles: 'Pick roles',
    picker_pick_skills: 'Pick skills',
    picker_pick_servers: 'Pick servers',
    picker_pick_commands: 'Pick commands',
    picker_pick_groups: 'Pick groups',
    picker_pick_people: 'Pick people',
    picker_pick_tools: 'Pick tools',
    picker_pick_sso: 'Pick SSO groups or people',
    picker_pick_server: 'Pick a server',
    picker_all_skills: 'every skill',
    picker_all_servers: 'every server',
    picker_all_commands: 'every command',
    picker_all_tools: 'every tool',
    governance_permissions: 'Permissions',
    governance_profiles: 'Bots',
    governance_routes: 'Routes',
    governance_grant_sources: 'Grant sources',
    governance_stat_roles: 'Roles',
    governance_stat_groups: 'Groups',
    governance_stat_users: 'Users',
    governance_stat_admins: 'Bootstrap admins',
    governance_stat_denials: 'Denials (24h)',
    governance_overview_note: 'Policy file: dashboard-governance.yaml. Denials include report-only would-deny events.',
    governance_conflict_reload: 'Policy changed elsewhere, reloading',
    governance_invalid_email: 'Enter a valid email address',
    governance_invalid_name: 'Enter a group name',
    governance_no_users: 'No user entries in the policy.',
    governance_no_groups: 'No group entries in the policy.',
    governance_no_events: 'No audit events yet.',
    governance_none: 'none',
    governance_approve: 'Approve',
    governance_reject: 'Reject',
    governance_approved: 'Approved',
    governance_rejected: 'Rejected',
    governance_no_pending: 'No pending approvals.',
    governance_approvals_note: 'Approve grants the request. Rejecting a skill also deletes it from disk.',
    governance_col_kind: 'Kind',
    governance_col_item: 'Item',
    governance_col_requested_by: 'Requested by',
    governance_col_requested_at: 'Requested',
    governance_kind_skill: 'Skill',
    governance_kind_integration: 'Integration',
    governance_kind_mcp: 'MCP',
    governance_kind_cli: 'CLI',
    governance_kind_grant: 'Access',
    governance_trigger: 'Asked for',
    governance_reason_blocked: 'Stopped by the access rules',
    governance_blocked_times: (n) => `Blocked ${n} times`,
    governance_explain_toggle: 'What this grants',
    governance_explain_capability: 'Capability',
    governance_explain_data: 'Data it can reach',
    governance_explain_tools: 'Tools',
    governance_explain_systems: 'External systems',
    governance_explain_permission: 'Permission still required',
    governance_explain_permission_notes: 'What that permission covers',
    governance_explain_scope: 'Applies to',
    governance_explain_duration: 'Duration',
    governance_explain_mitigations: 'Recommended mitigations',
    governance_explain_alternatives: 'Narrower alternative',
    governance_explain_dependencies: 'Also needed',
    governance_explain_target: 'Policy entry changed',
    governance_risk_external_comms: 'Sends messages outside this workstation',
    governance_risk_data_access: 'Reads data belonging to people',
    governance_risk_file_write: 'Creates or changes files',
    governance_risk_scheduling: 'Runs work on a schedule',
    governance_risk_financial: 'Can cause spend',
    governance_sug_toggle: 'Related access',
    governance_sug_confirmed: 'Needed for this to work',
    governance_sug_heuristic: 'Possibly related',
    governance_sug_none: 'Nothing else is standing in this person\u2019s way.',
    governance_sug_note: 'Each item is decided on its own. Nothing here is granted unless you approve it.',
    governance_sug_why: 'Why this may be needed',
    governance_sug_risk_low: 'Low risk',
    governance_sug_risk_medium: 'Medium risk',
    governance_sug_risk_high: 'High risk',
    governance_sug_approve: 'Approve',
    governance_sug_deny: 'Deny',
    governance_sug_ignore: 'Ignore',
    governance_sug_approved: 'Approved',
    governance_sug_denied: 'Denied',
    governance_sug_ignored: 'Set aside',
    governance_sug_manual: 'Not grantable from here. Change it in the access rules.',
    governance_sug_decided_by: 'Decided by',
    ...
    insights_skill_usage_footer: 'Counts from the runtime skills directory',
    ...
    settings_desc_sync_insights: 'Mirrors WebUI token usage to state.db so /insights includes browser session data. Off by default.',
    ...
    settings_desc_bot_name: 'Used for the default bot only. Other bots use their own bot names.',
    settings_desc_password: 'Enter a new password to set or change it. Leave blank to keep current setting.',
    password_placeholder: 'Enter new password…',
    password_env_var_locked: 'The password environment variable is currently set and takes precedence. Unset it and restart the server to manage the password from here.',
    password_env_var_locked_placeholder: 'Locked: password env var is set',
    disable_auth: 'Disable Auth',
    sign_out: 'Sign Out',
    settings_label_shutdown: 'Stop the SynthPulse WebUI server',
    ...
    settings_shutdown_confirm_title: 'Stop SynthPulse WebUI',
    settings_shutdown_confirm_message: 'Stop the SynthPulse WebUI server?',
    ...
    providers_oauth_config_yaml_hint: 'Token configured via config.yaml. To update, edit the providers section in your config.yaml or run agent auth.',
    providers_oauth_not_configured_hint: 'Not authenticated. Run agent auth in the terminal to configure this provider.',
    providers_save: 'Save',
    ...
    onboarding_title: 'Welcome to SynthPulse Control',
    onboarding_lead: 'A quick guided setup will verify the agent runtime, save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open SynthPulse',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify agent runtime and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum provider config.',
    ...
    onboarding_notice_system_ready: 'Agent runtime looks reachable from SynthPulse Control.',
    onboarding_notice_system_unavailable: 'Agent runtime is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: 'Agent runtime',
    ...
    onboarding_notice_setup_required: 'Choose a simple provider path here. Advanced OAuth flows still belong in the CLI for now.',
    ...
    onboarding_oauth_provider_ready_body: 'This instance is configured to use an OAuth provider (<strong>{provider}</strong>) that was set up via the CLI. No API key is needed here — click Continue to finish setup.',
    onboarding_oauth_provider_not_ready_title: 'OAuth provider not yet authenticated',
    onboarding_oauth_provider_not_ready_body: 'This instance is configured to use <strong>{provider}</strong>, which uses OAuth rather than an API key. Run the agent auth command or the model picker in a terminal to authenticate, then reload the Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Saved as a secret in the runtime .env file using',
    ...
    onboarding_workspace_help: 'Pick the model SynthPulse should use for new chats after setup completes.',
    ...
    cron_script_path_hint: 'Resolved under the runtime scripts directory unless an absolute path. Edit the script file on the server to change behavior.',
    ...
    cron_model_use_default: 'Default (use bot/system default)',
    ...
    profiles_empty_title: 'Select a bot',
    profiles_empty_sub: 'Pick an agent bot from the sidebar to view and edit its settings, or create a new one.',
    ...
    profiles_no_profiles: 'No bots found.',
    ...
    profile_use: 'Use',
    profile_switch_title: 'Switch to this bot',
    profile_delete_title: 'Delete this bot',
    profile_default_label: '(default)',
    profile_name_placeholder: 'Bot name (lowercase, a-z 0-9 hyphens)',
    profile_clone_label: 'Clone config from active bot',
    profile_model_label: 'Model / provider',
    profile_model_hint: 'Choose from configured providers and models for this new bot.',
    profile_model_use_default: 'Use active bot default',
    profile_base_url_placeholder: 'Base URL (optional, e.g. http://localhost:11434)',
    profile_api_key_placeholder: 'API key (optional)',
    manage_profiles: 'Manage bots',
    profiles_load_failed: 'Failed to load bots',
    profile_switched_new_conversation: (name) => `Switched to bot: ${name} — new conversation started`,
    profile_switched: (name) => `Switched to bot: ${name}`,
    ...
    profile_created: (name) => `Bot created: ${name}`,
    profile_delete_confirm_title: (name) => `Delete bot "${name}"?`,
    profile_delete_confirm_message: 'All sessions, config, skills, and memory for this bot will be permanently deleted. This cannot be undone.',
    profile_deleted: (name) => `Bot deleted: ${name}`,
    ...
    cron_diagram_label: 'Visual overview cron job',
    cron_emoji_label: 'Emoji',
    ...
    cron_share_button_long: 'Share with colleagues',
    cron_share_edit: 'Change sharing',
    cron_share_tooltip: 'Share with colleagues',
    cron_owner_label: 'Owner',
    cron_category_label: 'Category',
    cron_category_placeholder: 'Pick a category or add one',
    cron_category_hint: 'Groups the task in the list, for example per department.',
    cron_category_none: 'No category',
    cron_category_set: 'Set category',
    ...
    cron_share_nobody: 'nobody yet',
    cron_share_extra_label: 'Other address',
    cron_share_no_people: 'No colleagues found; use the address field.',
    cron_share_save: 'Save sharing',
    cron_share_saved: 'Sharing saved',
    cron_diagram_legend: 'Trigger, sources, processing, output. Dotted lines are what the run writes or changes.',
    cron_diagram_from_plan: 'from plan',
    cron_diagram_from_prompt: 'from prompt',
    cron_diagram_derived: 'derived from settings',
    cron_diagram_form_label: 'Diagram (Mermaid)',
    cron_diagram_form_hint: 'Optional flowchart of what this automation reads, does and writes. Shown in the task detail; without it a diagram is derived from the settings.',
    cron_deliver_label: 'Deliver output to',
    cron_deliver_local: 'Local (save output only)',
    cron_deliver_custom: 'Custom delivery target',
    cron_profile_label: 'Bot',
    cron_profile_server_default: 'server default',
    cron_profile_server_default_hint: 'Uses the WebUI server default bot at run time. Existing jobs without a bot keep this legacy behavior.',

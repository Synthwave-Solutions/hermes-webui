...
window.__registerHermesLocale('en', {
  ...
  "chat_mentions_error": "Could not prepare recipients. Your draft is kept.",
    ...
    offline_network_detail: 'SynPulse is unreachable from this browser right now.',
    offline_autorefresh: 'I will refresh this page automatically when SynPulse is reachable again.',
    ...
    mic_insecure_origin: 'Voice input needs a secure connection. Open SynPulse over HTTPS or from localhost to use the microphone.',
  ...
  untitled:'Untitled',
    ...
    session_title_regenerate_desc: 'Ask SynPulse to generate a fresh title from the conversation',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for SynPulse Control.',
    ...
    settings_help_meta: 'Resources and support for SynPulse Control.',
    ...
    kanban_work_queue_hint: 'This is the SynPulse work queue. Create or triage a task, assign it, move it to Ready, then let the dispatcher claim it.',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — SynPulse auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',
    ...
    sign_out: 'Sign Out',
    settings_label_shutdown: 'Stop the SynPulse WebUI server',
    ...
    settings_shutdown_confirm_title: 'Stop SynPulse WebUI',
    settings_shutdown_confirm_message: 'Stop the SynPulse WebUI server?',
    ...
    onboarding_title: 'Welcome to SynPulse Control',
    ...
    onboarding_notice_system_ready: 'Agent runtime looks reachable from SynPulse Control.',
    ...
    onboarding_workspace_help: 'Pick the model SynPulse should use for new chats after setup completes.',

...
window.__registerHermesLocale('ko', {
    ...
    status_profile: '프로필',
    status_hermes_home: 'SynthPulse 홈',
    ...
    settings_section_preferences_meta: 'SynthPulse Control의 기본값과 UI 동작.',
    ...
    settings_label_dashboard_mode: '공식 SynthPulse 대시보드',
    ...
    settings_desc_gateway_status: 'SynthPulse 게이트웨이 상태 (Telegram, Discord, Slack 등)',
    ...
    kanban_assignee_profiles_label: 'SynthPulse 프로필',
    ...
    sign_out: '로그아웃',
    settings_label_shutdown: 'SynthPulse Control 서버 중지',
    ...
    settings_shutdown_confirm_title: 'SynthPulse Control 중지',
    settings_shutdown_confirm_message: 'SynthPulse Control 서버를 중지할까요?',
    ...
    onboarding_title: 'SynthPulse Control에 오신 것을 환영합니다',
    onboarding_lead: '간단한 안내 설정으로 SynthPulse 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',

...
window.__registerHermesLocale('ko', {
    offline_title: '연결이 끊겼습니다',
    offline_browser_detail: '브라우저가 이 장치가 오프라인이라고 보고합니다.',
    offline_network_detail: '현재 이 브라우저에서 SynthPulse에 연결할 수 없습니다.',
    offline_autorefresh: 'SynthPulse에 다시 연결되면 이 페이지를 자동으로 새로고침합니다.',
    ...
    session_title_regenerate_desc: 'SynthPulse에게 대화에서 새 제목을 생성하도록 요청합니다',
    ...
    settings_section_preferences_meta: 'SynPulse Control의 기본값과 UI 동작.',
    ...
    settings_label_dashboard_mode: '공식 SynPulse 대시보드',
    settings_desc_dashboard_mode: '공식 synthpulse 대시보드에 연결 가능할 때 내비게이션 레일에 링크를 표시합니다. 공개 리버스 프록시 URL은 브라우저 전용 링크로만 저장되며 서버에서 프로브하지 않습니다.',
    ...
    settings_desc_gateway_status: 'SynPulse 게이트웨이 상태 (Telegram, Discord, Slack 등)',
    ...
    kanban_assignee_profiles_label: 'SynPulse 프로필',
    ...
    password_env_var_locked: '현재 password environment variable 환경 변수가 설정되어 있어 우선 적용됩니다. 변수를 해제하고 서버를 재시작해야 여기에서 비밀번호를 관리할 수 있습니다.',
    password_env_var_locked_placeholder: '잠금: password environment variable 환경 변수가 설정되어 있습니다',
    disable_auth: '인증 비활성화',
    sign_out: '로그아웃',
    settings_label_shutdown: 'SynPulse Control 서버 중지',
    ...
    settings_shutdown_confirm_title: 'SynPulse Control 중지',
    settings_shutdown_confirm_message: 'SynPulse Control 서버를 중지할까요?',
    ...
    onboarding_title: 'SynPulse Control에 오신 것을 환영합니다',
    onboarding_lead: '간단한 안내 설정으로 SynPulse 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',

...
def test_actual_worker_dispatch_keywords_match_original_sender(gateway,group,authenticated,managed):
    ...
    # Authenticated turns need the local worker's personal-context transport.
    if gateway and not group and authenticated is not True and not managed:

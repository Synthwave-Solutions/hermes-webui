...
- Open **My memory** for your own notes, user profile, personal agent preferences and project notes. Bot instructions and shared project instructions are separate from these personal documents.
